(function () {
  ...
  var clickTurnEl = function clickTurnEl(evt) {
    var turnDownWrapper = evt.target.closest('.page-contacts__sub-item');
    if (turnDownWrapper === null) {
      return;
    }

    var input = turnDownWrapper.querySelector('.page-contacts-radio-input');
    var turnDown = turnDownWrapper.querySelector('.turn-down');
